...
4. Redistribution. You may reproduce and distribute copies of the
   ...
   (d) You must include a NOTICE file if one was distributed with the
   Work. If the Work includes a "NOTICE" text file as part of its
   ...
   Works that You distribute, alongside or as an add-on to the
